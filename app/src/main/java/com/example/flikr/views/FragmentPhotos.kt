...
class FragmentPhotos : Fragment(), ImageRecyclerViewAdapter.AdapterCallback {
    ...
    override fun onCreateView(
        ...
        activity?.application?.let { application ->
            viewModel = ViewModelProvider.AndroidViewModelFactory.getInstance(application).create(SharedViewModel::class.java)
            viewModel.getImageData().observe(viewLifecycleOwner, {
                adapter?.setDataList(it, false)
